...
function fastAPIAxios() {
  ...
  axiosRetry(instance, {
    ...
    retryDelay: (retryCount) => {
      ...
      return retryCount * 500; // exponential backoff (1s, 2s, 3s)
    },
  ...
  instance.interceptors.response.use(
    ...
    (error) => {
      ...
      // Optionally, you can wrap error with a custom structure
